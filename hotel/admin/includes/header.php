...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top bg-danger p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="dashboard.php">REEF</a>
 </nav>
...
<!--       <li class="nav-item">
    ...
    <!--   <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'request') { echo 'active'; } ?>" href="request.php">
        ...
        Requests
           ...
           <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'no of room') { echo 'active'; } ?>" href="noofroom.php">
        <i class="fas fa-hotel"></i>
        no of room
       </a>
      </li>
    <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'extra bed') { echo 'active'; } ?>" href="extrabed.php">
        <i class="fas fa-bed"></i>
        extrabed
       </a>
      </li>
        <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'children') { echo 'active'; } ?>" href="children.php">
        <i class="fas fa-bed"></i>
        Children
       </a>
      </li>  
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'assets') { echo 'active'; } ?>" href="category.php">
   ...
   <!--    <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'date') { echo 'active'; } ?>" href="date.php">
